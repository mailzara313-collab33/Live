...
class UserRepository {
  ...
  static Future<Map<String, dynamic>> fetchUserTransaction({
    ...
    try {
      var transactionsList = await ApiBaseHelper().postAPICall(
        getWalTranApi,
        parameter,
      );
  ...
  static Future<Map<String, dynamic>> fetchUserWalletTransaction({
    ...
    try {
      var requestAmountTransactionsList = await ApiBaseHelper().postAPICall(
        getWalTranApi,
        parameter,
      );
      print(
  ...
  static Future<Map<String, dynamic>> sendAmountWithdrawRequest({
    ...
    try {
      var amountRequestData = await ApiBaseHelper().postAPICall(
        sendWithdrawalRequestApi,
        parameter,
      );
  ...
  getUserWalletAmountWithdrawalRequestTransactions({
    ...
    try {
      var requestTransactionsList = await ApiBaseHelper().postAPICall(
        getWithdrawalRequestApi,
        parameter,
      );

      return {
        'totalWalletAmountRequestTransactions': requestTransactionsList['total']
            .toString(),
  ...
  static Future<Map<String, dynamic>> fetchFavouriteProducts({
    ...
    try {
      var favouriteData = await ApiBaseHelper().postAPICall(
        getFavApi,
        parameter,
      );
