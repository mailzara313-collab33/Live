...
import 'package:eshop_multivendor/Screen/Language/Demo_Localization.dart';
...
final Uri loginWithEmailApi = Uri.parse('${baseUrl}login_with_email');
...
final Uri sendEmailOtpApi = Uri.parse('${baseUrl}send_email_otp');
final Uri verifyEmailOtpApi = Uri.parse('${baseUrl}verify_email_otp');
final Uri registerUserWithEmailApi = Uri.parse('${baseUrl}register_user_with_email');
final Uri sendProfileEmailVerificationOtpApi = Uri.parse('${baseUrl}send_profile_email_verification_otp');
final Uri verifyProfileEmailApi = Uri.parse('${baseUrl}verify_profile_email');
final Uri verifyProfileMobileApi = Uri.parse('${baseUrl}verify_profile_mobile');
final Uri getVerificationStatusApi = Uri.parse('${baseUrl}get_verification_status');
...
final Uri resetPasswordWithEmailApi = Uri.parse('${baseUrl}reset_password_with_email');
...
final Uri checkCartDelApi = Uri.parse(
  '${baseUrl}check_cart_products_delivarable',
);
...
final Uri getMidtransTransactionStatusApi = Uri.parse(
  '${baseUrl}get_midtrans_transaction_status',
);
final Uri getPaymentApi = Uri.parse('${baseUrl}payment');
final Uri midtransBebhookApi = Uri.parse('${baseUrl}midtrans_webhook');
final Uri createMidtransTransactionApi = Uri.parse(
...
final Uri checkShipRocketChargesOnProduct = Uri.parse(
  '${baseUrl}check_shiprocket_serviceability',
);
...
final Uri getPredefiendReasonsApi = Uri.parse(
  '${baseUrl}get_predefiend_reasons',
);
...
String getDocumentField(String variantId) {
  return 'documents[$variantId][]';
}
...
const String PRODUCT_ISRETURNABLE = 'product_is_returnable';
const String ISCANCLEABLE = 'is_cancelable';
const String PRODUCT_ISCANCELABLE = 'product_is_cancelable';
...
const String RETURN_REASON = 'return_reason';
const String OTHER_REASON = 'other_reason';
const String RETURN_ITEM_IMAGE = 'return_item_image';
const String RETURN_REQUEST_REMARK = 'return_request_remarks';
...
const String PAYPAL_RESPONSE_URL =
    '$baseUrl'
    'app_payment_status';
const String FLUTTERWAVE_RES_URL = '${baseUrl}flutterwave_payment_response';
...
String SINGLE_SELLER_SYSTEM_SELLER_ID = '';
...
bool SINGLE_SELLER_SYSTEM = false;
