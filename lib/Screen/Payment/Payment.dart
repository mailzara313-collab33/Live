  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: getSimpleAppBar(
          'PAYMENT_METHOD_LBL'.translate(context: context), context),
      body: isNetworkAvail
                  ...
                  child: Column(
                    children: [
                                              ...
                                              subtitle: Padding(
                                                ...
                                                child: Text(
                                                  context
                                                          .read<CartProvider>()
                                                          .isUseWallet!
                                                      ? '${'REMAIN_BAL'.translate(context: context)} : ${DesignConfiguration.getPriceFormat(context, context.read<CartProvider>().remWalBal)}'
                                                      : '${'TOTAL_BAL'.translate(context: context)} : ${DesignConfiguration.getPriceFormat(context, double.parse(userProvider.curBalance))!}',
                                                  style: TextStyle(
                      ...
                      SimBtn(
                        ...
                        size: 0.8,
                        title: 'DONE'.translate(context: context),
                        onBtnSelected: () {
