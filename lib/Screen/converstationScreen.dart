...
class ConverstationScreenState extends State<ConverstationScreen>
  ...
  void _scrollListener() {
    print(
        "is conversation screen seller id---> ${SINGLE_SELLER_SYSTEM_SELLER_ID}");
    ...
    Future.delayed(Duration.zero, () {
      ...
      if (widget.isGroup) {
        ...
        if (widget.personalChatHistory?.getUnreadMessage(
          ...
          ChatRepository.readMessages(
              isGroup: widget.isGroup,
              fromId: SINGLE_SELLER_SYSTEM == false
                  ? widget.personalChatHistory?.getOtherUserId() ?? ''
                  : SINGLE_SELLER_SYSTEM_SELLER_ID,
              userId: context.read<UserProvider>().userId!);
          ...
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                  ...
                  hintText: 'SEND_MESSAGE'.translate(context: context)),
            ),
          ),
                ...
                state.fetchMoreInProgress
                    ? Align(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            'LOADING_OLD_MESSAGES'.translate(context: context),
                          ),
                        ),
                      )
                    : const SizedBox(),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CupertinoButton(
                        child:
                            Text(tryAgainLabelKey.translate(context: context)),
                        onPressed: () {
                          context.read<ConverstationCubit>().fetchConverstation(
                              toId: context.read<UserProvider>().userId!,
                              isGroup: widget.isGroup,
...
Widget messageWidget(
  ...
  void openAttachment(
    ...
    if (fileExistWithPath.isNotEmpty) {
      OpenFile.open(fileExistWithPath);
      return;
    }
