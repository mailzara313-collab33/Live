  ...
  Widget build(BuildContext context) {
    return Consumer<ReviewPreviewProvider>(
      builder: (context, reviewPreviewProvider, _) {
        ...
        if (reviewPreviewProvider.productModel != null && curPos != null) {
          final reviewImgList = context
              .read<ProductDetailProvider>()
              .reviewImgList;
          if (curPos! < reviewImgList.length) {
            final reviewIndex = reviewImgList[curPos!].index!;
            final productRatingList = reviewPreviewProvider
                .productModel!
                .reviewList![0]
                .productRating!;
            if (reviewIndex < productRatingList.length) {
              model = productRatingList[reviewIndex];
            }
          }
        }
        return Scaffold(
              ...
              children: <Widget>[
                PhotoViewGallery.builder(
                  ...
                  pageController: PageController(
                    initialPage: reviewPreviewProvider.index!,
                  ),
                  onPageChanged: (index) {
                    if (mounted) {
                      setState(() {
