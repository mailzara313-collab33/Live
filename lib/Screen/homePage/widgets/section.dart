    ...
    return Consumer<HomePageProvider>(
      builder: (context, value, child) {
        return value.secLoading
            ...
            ? Center(
                child: Text(
                  'SECTION_IS_NOT_AVAILABLE_LBL'.translate(context: context),
                ),
              )
            : ListView.builder(
            ...
            children: [
              ...
              Flexible(
                ...
                child: GestureDetector(
                  child: Text(
                    'Show All'.translate(context: context),
...
class SingleSection extends StatelessWidget {
  ...
  Future<void> _onOfferImageClick(
    BuildContext context,
    Model offerImageData,
  ) async {
        ...
        ? sectionStyle == DEFAULT
              ...
              : Padding(
                  ...
                  child: GridView.count(
                    ...
                    crossAxisSpacing: 8,
                    children: List.generate(
                      productList.length < 6 ? productList.length : 6,
                      (index) {
