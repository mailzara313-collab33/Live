...
class StateCart extends State<Cart> with TickerProviderStateMixin {
  ...
  Future<void> cartFun({
    ...
    context.read<CartProvider>().productIds.add(
      context
          .read<CartProvider>()
          .saveLaterList[index]
          .productList![0]
    ...
    context.read<CartProvider>().addCartItem(
      context.read<CartProvider>().saveLaterList[index],
    );
  ...
  Future<void> callApi() async {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (context.read<UserProvider>().email != '') {
        context.read<CartProvider>().emailController.text = context
            .read<UserProvider>()
            .email;
      }
      ...
      if (context.read<UserProvider>().userId != '') {
        ...
        _getOffCart();
        context.read<CartProvider>().productVariantIds = (await db
            .getSaveForLater())!;
  ...
  Future checkout() {
    ...
    List<SectionModel> tempCartListForTestCondtion = context
        .read<CartProvider>()
        .cartList;
                                      ...
                                      SimBtn(
                                        ...
                                        onBtnSelected:
                                            ...
                                            ? () {
                                                ...
                                                if (tempCartListForTestCondtion[0]
                                                            .productType !=
                                                        'digital_product' &&
                                                    (context
                                                                .read<
  ...
  Future<void> checkDeliverable(bool navigate) async {
    ...
    if (isNetworkAvail) {
      try {
        ...
        var parameter = {ADD_ID: context.read<CartProvider>().selAddress};
        apiBaseHelper
            .postAPICall(checkCartDelApi, parameter)
            .then(
              (getdata) {
                ...
                if (error) {
                  context.read<CartProvider>().deliverableList = (data)
                  ...
                  if (data.isEmpty) {
                    ...
                    if (isDeliverible) {
                      getShipRocketDeliveryCharge(
                        shipRocket: isShipRocket != null && isShipRocket
                            ? '1'
                            : '0',
                        navigate: navigate,
                      );
  ...
  Future<void> razorpayPayment(String orderID, String? msg) async {
    ...
    String amt = (context.read<CartProvider>().totalPrice * 100)
        .toStringAsFixed(2);
    ...
    try {
      ...
      var response = await ApiBaseHelper().postAPICall(createRazorpayOrder, {
        'order_id': orderID,
      });
  ...
  Future<void> deleteOrder(String orderId) async {
    try {
      var parameter = {ORDER_ID: orderId};
  ...
  void paytmPayment(
    ...
    try {
      apiBaseHelper
          .postAPICall(getPytmChecsumkApi, parameter)
          .then(
            (getdata) async {
              bool error = getdata['error'];
              ...
              if (!error) {
                ...
                var response = await PaytmPaymentsAllinonesdk()
                    .startTransaction(
  ...
  void payWithPhonePeCart(String orderId) {
    initiatePhonePePayment(
      ...
      onFailure: () {
        deleteOrder(orderId);
        setSnackbar(
          'PHONEPE_PAYMENT_FAILED'.translate(context: context),
          context,
        );
        if (mounted) {
          context.read<CartProvider>().checkoutState!(
  ...
  Future<void> placeOrder(String? tranId) async {
    ...
    if (isNetworkAvail) {
      ...
      try {
        ...
        request.fields[TOTAL] = context
            .read<CartProvider>()
            .oriPrice
            .toString();
        request.fields[FINAL_TOTAL] = context
            .read<CartProvider>()
            .totalPrice
            .toString();

        request.fields[DEL_CHARGE] = context
            .read<CartProvider>()
            .deliveryCharge
            .toString();

        request.fields[TAX_PER] = context
            .read<CartProvider>()
            .taxPer
            .toString();
        ...
        request.fields[WALLET_BAL_USED] = context
            .read<CartProvider>()
            .usedBalance
            .toString();
        request.fields[ORDER_NOTE] = context
            .read<CartProvider>()
            .noteController
            .text;
        ...
        if (context.read<CartProvider>().isPromoValid!) {
          ...
          request.fields[PROMO_DIS] = context
              .read<CartProvider>()
              .promoAmt
              .toString();
        }
        ...
        for (final section in cartList) {
          ...
          if (slug != null &&
            ...
            String? token = await DatabaseHelper()
                .getLatestAppLinkTokenForProduct(slug);
        ...
        for (final id in ids) {
          ...
          final images = context.read<CartProvider>().getPrescriptionImages(
            trimmedId,
          );
        ...
        logHttpMultipartRequestAsCurl(request);
  ...
  Future<void> instamojoPayment(String orderId) async {
    try {
      var parameter = {ORDER_ID: orderId};
      apiBaseHelper
          .postAPICall(getInstamojoWebviewApi, parameter)
          .then(
            (getdata) {
  ...
  Future<void> paypalPayment(String orderId) async {
    try {
      ...
      apiBaseHelper
          .postAPICall(paypalTransactionApi, parameter)
          .then(
            (getdata) {
              bool error = getdata['error'];
              String? msg = getdata['message'];
  ...
  Future<void> addTransaction(
    ...
    try {
      ...
      apiBaseHelper
          .postAPICall(addTransactionApi, parameter)
          .then(
            (getdata) {
              bool error = getdata['error'];
    ...
    if (isNetworkAvail) {
      try {
        ...
        if (response.status.toString() == 'PaymentStatus.Success') {
          ...
          await updateOrderStatus(orderID: orderID, status: PLACED);
          addTransaction(response.paymentId, orderID, PLACED, msg, true);
        }
  ...
  Future<void> midTrasPayment(
    ...
    if (isNetworkAvail) {
      try {
        ...
        apiBaseHelper
            .postAPICall(createMidtransTransactionApi, parameter)
            .then(
              (getdata) {
                bool error = getdata['error'];
                String? msg = getdata['message'];
  ...
  Future<void> stripePayment(
    ...
    var response = await StripeService.payWithPaymentSheet(
      amount: (context.read<CartProvider>().totalPrice * 100)
          .toInt()
          .toString(),
  ...
  Future<void> flutterwavePayment(
    ...
    if (isNetworkAvail) {
      try {
        ...
        apiBaseHelper
            .postAPICall(flutterwaveApi, parameter)
            .then(
              (getdata) {
                bool error = getdata['error'];
                String? msg = getdata['message'];
  ...
  Future<void> _getCart(String save) async {
    ...
    if (isNetworkAvail) {
      try {
        ...
        apiBaseHelper
            .postAPICall(getCartApi, parameter)
            .then(
              (getdata) {
                bool error = getdata['error'];
                String? msg = getdata['message'];
                if (!error) {
                  ...
                  context.read<CartProvider>().oriPrice = double.parse(
                    getdata[SUB_TOTAL],
                  );

                  context.read<CartProvider>().taxPer = double.parse(
                    getdata[TAX_PER],
                  );

                  if (IS_SHIPROCKET_ON == '0') {
                    context.read<CartProvider>().totalPrice = context
                        .read<CartProvider>()
                        .oriPrice;
                  } else {
                    context.read<CartProvider>().totalPrice =
                ...
                context.read<CartProvider>().deliveryCharge +
                  ...
                  if (getdata.containsKey(PROMO_CODES)) {
                    ...
                    context.read<CartProvider>().promoList = (promo as List)
                        .map((e) => Promo.fromJson(e))
                        .toList();
                  }

                  for (int i = 0; i < cartList.length; i++) {
                    context.read<CartProvider>().controller.add(
  ...
  Future<void> _getOffCart() async {
    if (context.read<CartProvider>().productIds.isNotEmpty) {
      ...
      if (isNetworkAvail) {
        var parameter = {
          'product_variant_ids': context.read<CartProvider>().productIds.join(
            ',',
          ),
        };
              ...
              if (!error) {
                ...
                for (int i = 0; i < cartList.length; i++) {
                  for (int j = 0; j < cartList[i].prVarientList!.length; j++) {
                    if (context.read<CartProvider>().productIds.contains(
                      ...
                      double price = double.parse(
                        cartList[i].prVarientList![j].disPrice!,
                      );
                      if (price == 0) {
                        price = double.parse(
                          cartList[i].prVarientList![j].price!,
                        );
                      }
                      double total = qty == ''
                          ? price
          ...
          (value) => context.read<ProductListProvider>().getProductList().then(
            (value) async {
              ...
              if (!error) {
                ...
                for (int i = 0; i < cartList.length; i++) {
                  for (int j = 0; j < cartList[i].prVarientList!.length; j++) {
                    if (context.read<CartProvider>().productVariantIds.contains(
                      cartList[i].prVarientList![j].id,
                    )) {
                                ...
                                children: [
                                  ...
                                  cartList.isNotEmpty
                                      ? SimBtn(
                                          ...
                                          height: 40,
                                          borderRadius: circularBorderRadius5,
                                          title: 'PROCEED_CHECKOUT'.translate(
                                            context: context,
                                          ),
                                          onBtnSelected: () {
                  ...
                  children: <Widget>[
                          ...
                          children: [
                            Container(
                              ...
                              child: TextField(
                                ...
                                controller: context.read<CartProvider>().promoC,
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: 'PROMOCODE_LBL'.translate(
                                    context: context,
                                  ),
                                ),
                                onChanged: (val) {
                                  setState(() {
                                    if (val.isEmpty) {
                                      context.read<CartProvider>().isPromoLen =
                                          false;
                                      context
                                              .read<CartProvider>()
                                              .isPromoValid =
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: context.read<CartProvider>().cartList.isNotEmpty
                            ? Column(
                                mainAxisSize: MainAxisSize.min,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                        ...
                                        SimBtn(
                                          ...
                                          title:
                                              context
                                                  .read<CartProvider>()
                                                  .isPromoLen
                                              ? 'VALI_PRO_CODE'.translate(
                                                  context: context,
                                                )
                                              : 'PROCEED_CHECKOUT'.translate(
                                                  context: context,
                                                ),
                                          onBtnSelected: () async {
                                            if (double.parse(
  ...
  Future<void> _getAddress() async {
    ...
    if (isNetworkAvail) {
      try {
        ...
        apiBaseHelper
            .postAPICall(getAddressApi, parameter)
            .then(
              (getdata) {
                bool error = getdata['error'];
                ...
                if (!error) {
                  ...
                  context.read<CartProvider>().addressList = (data as List)
                  ...
                  if (context.read<CartProvider>().addressList.length == 1) {
                    ...
                    context.read<CartProvider>().selAddress = context
                        .read<CartProvider>()
                        .addressList[0]
                        .id;
                    if (!ISFLAT_DEL) {
