...
class OutOffStockLableWidget extends StatelessWidget {
  String? availability;
  OutOffStockLableWidget({super.key, this.availability});
...
Widget getRattingIcons(BuildContext context, String? rating) {
  return Padding(
...
Widget commanField(String? madeIn, String heading, BuildContext context) {
  return Padding(
...
Widget isCancelable(String? pos, BuildContext context) {
  return Padding(
    padding:
    ...
    child: Row(
      children: [
        Expanded(
          child: Text(
            'CANCELLABLE'.translate(context: context),
            style: Theme.of(context).textTheme.titleSmall!.copyWith(
                  fontFamily: 'ubuntu',
                ),
          ),
...
Widget isReturnable(String? returnable, BuildContext context) {
  if (returnable == '1') {
  ...
  return Padding(
    ...
    child: Row(
      children: [
        Expanded(
          child: Text(
            'RETURNABLE'.translate(context: context),
            style: Theme.of(context).textTheme.titleSmall!.copyWith(
                  fontFamily: 'ubuntu',
                ),
          ),
...
Widget getImagePart(
    String? image, int index, String? id, BuildContext context) {
  return Hero(
  ...
  return Padding(
    ...
    child: Row(
      ...
      children: <Widget>[
        ...
        if (double.parse(model.prVarientList![model.selVarient!].disPrice!) !=
                0 &&
...
Widget getProductName(String? name) {
  return Padding(
...
Widget getListViewIteam(String attribute, String value) {
  return Row(
    children: [
      Flexible(
        child: Text(
