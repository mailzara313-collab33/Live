...
class StateRate extends State<ReviewList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: getSimpleAppBar(
            'CUSTOMER_REVIEW_LBL'.translate(context: context), context),
        body: _review(),
            ...
            child: Row(
              ...
              children: [
                Row(
                  children: [
                    Text(
                      "${context.read<ProductDetailProvider>().reviewList.length} ${"REVIEW_LBL".translate(context: context)}",
                      style: const TextStyle(
                ...
                context.read<ProductDetailProvider>().reviewList.isNotEmpty
                    ? Row(
                        children: [
                          ...
                          Text(
                            'WITH_PHOTO'.translate(context: context),
                            style: const TextStyle(fontWeight: FontWeight.bold),
                          ),
                        ],
                      )
  ...
  Widget getRatingIndicator(int totalStar) {
    return Padding(
      padding: const EdgeInsets.all(5.0),
      child: Stack(
        children: [
